...
class JobTitleDetailPage extends StatefulWidget {
  ...
  @override
  State<JobTitleDetailPage> createState() => _JobTitleDetailPageState();
}

class _JobTitleDetailPageState extends State<JobTitleDetailPage> {
  @override
  void initState() {
    super.initState();
