...
class JobTitleProjectWorkerPage extends StatefulWidget {
  const JobTitleProjectWorkerPage({super.key});

  @override
  State<JobTitleProjectWorkerPage> createState() => _JobTitleProjectWorkerPageState();
}

class _JobTitleProjectWorkerPageState extends State<JobTitleProjectWorkerPage> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _loadData() async {
    ...
    await provider.loadJobTitles(typeRole: 'worker', typeBranch: 'project');
  }
