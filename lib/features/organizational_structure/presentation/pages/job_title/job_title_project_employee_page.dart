...
class JobTitleProjectEmployeePage extends StatefulWidget {
  const JobTitleProjectEmployeePage({super.key});

  @override
  State<JobTitleProjectEmployeePage> createState() => _JobTitleProjectEmployeePageState();
}

class _JobTitleProjectEmployeePageState extends State<JobTitleProjectEmployeePage> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _loadData() async {
    ...
    await provider.loadJobTitles(typeRole: 'employee', typeBranch: 'project');
  }
