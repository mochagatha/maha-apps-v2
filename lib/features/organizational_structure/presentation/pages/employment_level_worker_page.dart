...
class EmploymentLevelWorkerPage extends StatefulWidget {
  const EmploymentLevelWorkerPage({super.key});

  @override
  State<EmploymentLevelWorkerPage> createState() => _EmploymentLevelWorkerPageState();
}

class _EmploymentLevelWorkerPageState extends State<EmploymentLevelWorkerPage> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _loadData() async {
    ...
    await provider.loadEmploymentLevelsByType(typeRole: 'worker');
  }
