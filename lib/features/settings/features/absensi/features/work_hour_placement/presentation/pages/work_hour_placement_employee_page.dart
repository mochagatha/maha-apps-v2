...
class WorkHourPlacementEmployeePage extends StatefulWidget {
  const WorkHourPlacementEmployeePage({super.key});

  @override
  State<WorkHourPlacementEmployeePage> createState() =>
      _WorkHourPlacementEmployeePageState();
}

class _WorkHourPlacementEmployeePageState
    extends State<WorkHourPlacementEmployeePage> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildLabel("Penempatan Karyawan"),
            ...
            _buildLabel("Jam Kerja Karyawan"),
