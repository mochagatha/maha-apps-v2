...
class JobTitleBranchPage extends StatelessWidget {
  const JobTitleBranchPage({super.key});
    ...
    return [
      {
        ...
        'text': 'Karyawan',
        'action': () {
          context.push(AppRoutes.jobTitleBranchEmployee.path);
        },
      },
      {
        ...
        'text': 'Pekerja Harian',
        'action': () {
          context.push(AppRoutes.jobTitleBranchWorker.path);
        },
      },
    ];
  }
