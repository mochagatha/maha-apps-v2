...
class MenuGrid extends StatelessWidget {
  ...
  const MenuGrid({super.key, required this.menus, this.notificationCount});
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final details = MenuMapper.getMenuDetails(
          menu.name,
        ); // Using name as V1 used name/id interchangeably or specific constants
