...
class SelfieKtpResultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Hasil Photo"), backgroundColor: Colors.white, elevation: 0, foregroundColor: Colors.black),
          ...
          children: [
             SizedBox(
              width: double.infinity,
               child: ElevatedButton(
                  ...
                  child: const Text('Unggah Foto', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                ),
             ),
            ...
            SizedBox(
              ...
              child: OutlinedButton(
                ...
                child: const Text('Ambil Ulang', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.red)),
              ),
            ),
          ],
        ),
