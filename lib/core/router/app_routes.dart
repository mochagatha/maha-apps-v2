...
class AppRoutes {
  ...
  static const adminFaceVerification = AppRoute('admin-face-verification', '/admin-face-verification');
  ...
  static const biodataCreateSignature = AppRoute('biodata-create-signature', '/biodata/signature/create');
  ...
  static const employeeVerification = AppRoute('employee-verification', '/recruitment/employee-verification');
  static const employeePersonalData = AppRoute('employee-personal-data', '/recruitment/personal-data/employee');
  ...
  static const structureProject = AppRoute('structure-project', '/organizational-structure/project');
  static const organizationalChart = AppRoute('organizational-chart', '/organizational-structure/chart');
  static const employmentLevel = AppRoute('employment-level', '/organizational-structure/employment-level');
  static const employmentLevelOffice = AppRoute('employment-level-office', '/organizational-structure/employment-level/office');
  static const employmentLevelProject = AppRoute('employment-level-project', '/organizational-structure/employment-level/project');
  static const employmentLevelOfficeEmployee = AppRoute('employment-level-office-employee', '/organizational-structure/employment-level/office/employee');
  static const employmentLevelOfficeWorker = AppRoute('employment-level-office-worker', '/organizational-structure/employment-level/office/worker');
  static const employmentLevelProjectEmployee = AppRoute('employment-level-project-employee', '/organizational-structure/employment-level/project/employee');
  static const employmentLevelProjectWorker = AppRoute('employment-level-project-worker', '/organizational-structure/employment-level/project/worker');
  static const departmentList = AppRoute('department-list', '/organizational-structure/department');
  static const departmentOffice = AppRoute('department-office', '/organizational-structure/department/office');
  static const departmentProject = AppRoute('department-project', '/organizational-structure/department/project');
  static const jobTitleList = AppRoute('job-title-list', '/organizational-structure/job-title');
  static const jobTitleOffice = AppRoute('job-title-office', '/organizational-structure/job-title/office');
  static const jobTitleProject = AppRoute('job-title-project', '/organizational-structure/job-title/project');
  static const jobTitleOfficeEmployee = AppRoute('job-title-office-employee', '/organizational-structure/job-title/office/employee');
  static const jobTitleOfficeWorker = AppRoute('job-title-office-worker', '/organizational-structure/job-title/office/worker');
  static const jobTitleProjectEmployee = AppRoute('job-title-project-employee', '/organizational-structure/job-title/project/employee');
  static const jobTitleProjectWorker = AppRoute('job-title-project-worker', '/organizational-structure/job-title/project/worker');
  static const jobTitleSelection = AppRoute('job-title-selection', '/organizational-structure/job-title-selection');
  static const employeeByJobTitleSelection = AppRoute('employee-by-job-title-selection', '/organizational-structure/employee-by-job-title-selection');
  ...
  static const accessScreenDetail = AppRoute('access-screen-detail', '/settings/akses-layar/detail');
  ...
  static const settingsAbsensiLembur = AppRoute('settings-absensi-lembur', '/settings/absensi/lembur');
  static const settingsAbsensiAbsenDimanaSaja = AppRoute('settings-absensi-absen-dimana-saja', '/settings/absensi/absen-dimana-saja');
  static const settingsAbsensiPerbaikanKehadiran = AppRoute('settings-absensi-perbaikan-kehadiran', '/settings/absensi/perbaikan-kehadiran');
  static const settingsPenempatanKerja = AppRoute('settings-penempatan-kerja', '/settings/penempatan-kerja');
  static const settingsLibur = AppRoute('settings-libur', '/settings/libur');
  static const settingsHirarkiOffice = AppRoute('settings-hirarki-office', '/settings/hirarki-office');
  static const settingsLembur = AppRoute('settings-lembur', '/settings/lembur');
  static const settingsTindakanKaryawan = AppRoute('settings-tindakan-karyawan', '/settings/tindakan-karyawan');
  ...
  static const settingsFormatDanDraf = AppRoute('settings-format-dan-draf', '/settings/format-dan-draf');
  static const settingsHakAksesMenu = AppRoute('settings-hak-akses-menu', '/settings/hak-akses-menu');
  ...
  static const settingsAlurOperasional = AppRoute('settings-alur-operasional', '/settings/alur-operasional');
  ...
  static const settingsKpiTargetPoint = AppRoute('settings-kpi-target-point', '/settings/kpi/target-point');
  static const settingsKpiPenilaianKinerja = AppRoute('settings-kpi-penilaian-kinerja', '/settings/kpi/penilaian-kinerja');
  static const settingsKpiUbahPeriodeSurat = AppRoute('settings-kpi-ubah-periode-surat', '/settings/kpi/ubah-periode-surat');
  static const settingsKpiPengaturanAktivasiPoint = AppRoute('settings-kpi-pengaturan-aktivasi-point', '/settings/kpi/pengaturan-aktivasi-point');

  // Pelacakan Jam Kerja
  static const settingsPelacakanJamKerja = AppRoute('pelacakan-jam-kerja', '/settings/pelacakan-jam-kerja');
  static const pelacakanSettings = AppRoute('pelacakan-settings', '/settings/pelacakan-jam-kerja/settings');
  static const pelacakanEmployeeDetail = AppRoute('pelacakan-employee-detail', '/settings/pelacakan-jam-kerja/employee');
}
